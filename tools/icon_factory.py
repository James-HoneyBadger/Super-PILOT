"""
Icon factory for Time Warp toolbar buttons.
    ...
    try:
        ...
        d.polygon(
            [
                ...
                (int(size * 0.28), int(size * 0.82)),
                (int(size * 0.82), int(size * 0.5)),
            ],
            fill=(0, 122, 204, 255),
        )
        ...
        d.ellipse(
            [
                ...
                (int(size * 0.78), int(size * 0.62)),
            ],
            fill=(255, 193, 7, 255),
        )
        d.ellipse(
            [
                (int(size * 0.38), int(size * 0.12)),
                (int(size * 0.62), int(size * 0.36)),
            ],
            fill=(255, 193, 7, 255),
        )
        d.line(
            [
                (int(size * 0.28), int(size * 0.42)),
                (int(size * 0.12), int(size * 0.58)),
            ],
            fill=(30, 30, 30, 255),
            width=1,
        )
        d.line(
            [
                (int(size * 0.72), int(size * 0.42)),
                (int(size * 0.88), int(size * 0.58)),
            ],
            fill=(30, 30, 30, 255),
            width=1,
        )
        ...
        d.polygon(
            [
                ...
                (int(size * 0.32), int(size * 0.46)),
                (int(size * 0.44), int(size * 0.46)),
                (int(size * 0.44), int(size * 0.66)),
                (int(size * 0.56), int(size * 0.66)),
        ...
        d.rectangle(
            [
                (int(size * 0.30), int(size * 0.28)),
                (int(size * 0.70), int(size * 0.46)),
            ],
            fill=(255, 255, 255, 255),
        )
