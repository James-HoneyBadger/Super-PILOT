...
END'''
        ...
        self.assertEqual(self.interp.variables.get('SENSOR_VALUE', 'NOTSET'), 'NOTSET')  # Won't be set in simulation
...
END'''
        ...
        self.assertEqual(self.interp.variables.get('PIN19_VAL', 0), 0)  # Default simulation value
...
END'''
    ...
    def test_cross_platform_compatibility(self):
        ...
        self.assertFalse(self.interp.rpi.gpio_available)  # Should be False on non-RPi systems
