"""
Test suite for Time Warp UI components and modern interface
...
class TestModernUI(TestCase):
    ...
    def test_language_detection(self, headless_ide):
        ...
        # Test Logo detection
        mock_editor.get = Mock(
            return_value="FORWARD 100\nRIGHT 90\nREPEAT 4 [FORWARD 50]"
        )
        headless_ide.update_status_indicators()

        # Test BASIC detection
        mock_editor.get = Mock(
            return_value='10 PRINT "Hello"\n20 LET X = 5\n30 GOTO 10'
        )
        headless_ide.update_status_indicators()
    ...
    def test_responsive_design_elements(self, headless_ide):
        ...
        headless_ide.root.title.assert_called_with(
            "Time Warp II - Advanced Educational IDE"
        )
